					...
					<div className=" ItemDescriptionPage pt-[15vh] p-56">
						...
						<div>
							<img
								...
								src={this.props.data[0].gallery[this.state.selectedPhoto]}
							/>
						</div>
						<div className=" ProductDescr">
							...
							<p className="ProductPrice">
								...
								<br />
								{this.state.data[0].prices[Currency].currency.symbol +
									this.state.data[0].prices[Currency].amount}
							</p>
							<button onClick={this.addToCart} className="AddToCartBtn">
								ADD TO CART
							</button>
