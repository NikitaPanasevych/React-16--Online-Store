        ...
        return(
            <div className="Menu" >
                <div className="Categories" >
                    {this.state.data.map((element, index) => <Category name={element.name} id={index} handleCategoryChange={this.handleCategoryChange} />)}
                </div>
                <div className="StoreIcon">
                    <img src={storeIcon} alt="Store Icon" />
                </div>
                <div  className="CurrencyBtn">
                    <svg onClick={()=>this.setState({currencyDropdown: !this.state.currencyDropdown})} width="45" height="45" viewBox="0 0 39 30" fill="none" xmlns="http://www.w3.org/2000/svg">
